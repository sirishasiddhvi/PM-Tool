...
import { useAddScope } from "./AddScopeFunction";
...
export const AddScope = () => {
  ...
  return (
    <CustomContainer maxwidth="md">
      ...
      >
        <CustomTypography variant="h3">Add Scope</CustomTypography>
       ...
       <CustomTextField
            ...
            <CustomGrid item md={6} lg={6} xl={6} sm={12} xs={12}>           <CKEditor
            ...
            <CustomGrid item md={6} lg={6} xl={6} sm={12} xs={12}>
            { scope_images.length!=0 && scope_images.map((article)=>(
            ...
            <CustomGrid item md={6} lg={6} xl={6} sm={12} xs={12}></CustomGrid>
            <CustomTextField
              select
              size="small"
              type="text"
